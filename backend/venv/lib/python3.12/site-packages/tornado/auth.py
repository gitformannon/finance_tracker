...
.. testcode::
    ...
    class GoogleOAuth2LoginHandler(tornado.web.RequestHandler,
        ...
        async def get(self):
            ...
            # best to get it from your api configuration instead of from
...
class OpenIdMixin(object):
    ...
    * ``_OPENID_ENDPOINT``: the identity provider's URI.
    ...
    def authenticate_redirect(
        ...
        all those attributes for your api, you can request fewer with
...
class GoogleOAuth2Mixin(OAuth2Mixin):
    ...
    * Depending on permissions required, you may need to set your api to
