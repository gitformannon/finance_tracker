...
class WriteAccessAllowed(TelegramObject):
    """
    This object represents a service message about a user allowing a telegram_bot to write messages after
    adding the telegram_bot to the attachment menu or launching a Web App from a link.
