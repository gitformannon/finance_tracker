...
class WriteAccessAllowed(TelegramObject):
    """
    This object represents a service message about a user allowing a telegram-bot to write messages after
    adding the telegram-bot to the attachment menu or launching a Web App from a link.
