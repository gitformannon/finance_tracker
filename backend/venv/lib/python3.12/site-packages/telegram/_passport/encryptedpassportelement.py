...
class EncryptedPassportElement(TelegramObject):
    """
    Contains information about documents or other Telegram Passport elements shared with the telegram-bot
    by the user. The data has been automatically decrypted by python-telegram-telegram-bot.
