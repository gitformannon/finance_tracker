...
"""Contains information about Telegram Passport data shared with the telegram-bot by the user."""
...
class PassportData(TelegramObject):
    ...
    def decrypted_data(self) -> Tuple[EncryptedPassportElement, ...]:
        ...
        Tuple[:class:`telegram.EncryptedPassportElement`]: Lazily decrypt and return information
            about documents and other Telegram Passport elements which were shared with the telegram-bot.
