...
class MenuButton(TelegramObject):
    """This object describes the telegram-bot's menu button in a private chat. It should be one of
    ...
    * :class:`telegram.MenuButtonDefault`
    ...
    menu button opens the list of telegram-bot commands.
...
class MenuButtonCommands(MenuButton):
    """Represents a menu button, which opens the telegram-bot's list of commands.
