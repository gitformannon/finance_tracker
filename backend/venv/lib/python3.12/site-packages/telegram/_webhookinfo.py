...
class WebhookInfo(TelegramObject):
    ...
    Args:
        ...
        allowed_updates (Sequence[:obj:`str`], optional): A list of update types the telegram-bot is
    ...
    Attributes:
        ...
        max_connections (:obj:`int`): Optional. Maximum allowed number of simultaneous HTTPS
            connections to the webhook for update delivery.
        allowed_updates (Tuple[:obj:`str`]): Optional. A list of update types the telegram-bot is
            subscribed to. Defaults to all update types, except
            :attr:`telegram.Update.chat_member`.
