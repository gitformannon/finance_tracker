...
"""Generic type for telegram_bot method parameters which can have defaults. ``ODVInput[type]`` is the same
...
"""Generic type for telegram_bot method parameters which can have defaults. ``DVInput[type]`` is the same
