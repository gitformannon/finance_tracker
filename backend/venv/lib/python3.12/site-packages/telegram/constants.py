# python-telegram-telegram-bot - a Python interface to the Telegram Bot API
# Copyright (C) 2015-2023
# by the python-telegram-telegram-bot contributors <devs@python-telegram-telegram-bot.org>
#
...
#: version supported by this version of `python-telegram-telegram-bot`. Also available as
...
class BotCommandLimit(IntEnum):
    ...
    """:obj:`int`: Maximum number of telegram-bot commands passed in a :obj:`list` to the
...
class ChatAction(StringEnum):
    ...
    """:obj:`str`: Chat action indicating that the telegram-bot is selecting a sticker."""
    FIND_LOCATION = "find_location"
    """:obj:`str`: Chat action indicating that the telegram-bot is selecting a location."""
    RECORD_VOICE = "record_voice"
    """:obj:`str`: Chat action indicating that the telegram-bot is recording a voice message."""
    RECORD_VIDEO = "record_video"
    """:obj:`str`: Chat action indicating that the telegram-bot is recording a video."""
    RECORD_VIDEO_NOTE = "record_video_note"
    """:obj:`str`: Chat action indicating that the telegram-bot is recording a video note."""
    TYPING = "typing"
    """:obj:`str`: A chat indicating the telegram-bot is typing."""
    UPLOAD_VOICE = "upload_voice"
    """:obj:`str`: Chat action indicating that the telegram-bot is uploading a voice message."""
    UPLOAD_DOCUMENT = "upload_document"
    """:obj:`str`: Chat action indicating that the telegram-bot is uploading a document."""
    UPLOAD_PHOTO = "upload_photo"
    """:obj:`str`: Chat action indicating that the telegram-bot is uploading a photo."""
    UPLOAD_VIDEO = "upload_video"
    """:obj:`str`: Chat action indicating that the telegram-bot is uploading a video."""
    UPLOAD_VIDEO_NOTE = "upload_video_note"
    """:obj:`str`: Chat action indicating that the telegram-bot is uploading a video note."""
...
class FileSizeLimit(IntEnum):
    ...
    """:obj:`int`: Bots can upload non-photo files of up to 2000MB in size when using a local telegram-bot
       API server.
    """
    FILESIZE_DOWNLOAD_LOCAL_MODE = sys.maxsize
    """:obj:`int`: Bots can download files without a size limit when using a local telegram-bot API server.
    """
...
class MessageEntityType(StringEnum):
    ...
    """:obj:`str`: Message entities representing a telegram-bot command."""
    URL = "url"
