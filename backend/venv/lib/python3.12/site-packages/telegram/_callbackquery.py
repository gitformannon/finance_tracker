...
class CallbackQuery(TelegramObject):
    ...
    If the button that originated the query was attached to a message sent by the telegram-bot, the field
    :attr:`message` will be present. If the button was attached to a message sent via the telegram-bot (in
    ...
    Args:
        ...
        inline_message_id (:obj:`str`, optional): Identifier of the message sent via the telegram-bot in
    ...
    async def answer(
        ...
        *,
        ...
        """Shortcut for::
             ...
             await telegram-bot.answer_callback_query(update.callback_query.id, *args, **kwargs)
