...
class CallbackQuery(TelegramObject):
    ...
    If the button that originated the query was attached to a message sent by the telegram_bot, the field
    :attr:`message` will be present. If the button was attached to a message sent via the telegram_bot (in
    ...
    Args:
        ...
        inline_message_id (:obj:`str`, optional): Identifier of the message sent via the telegram_bot in
    ...
    async def answer(
        ...
        *,
        ...
        """Shortcut for::
             ...
             await telegram_bot.answer_callback_query(update.callback_query.id, *args, **kwargs)
