...
class InlineQuery(TelegramObject):
    """
    This object represents an incoming inline query. When the user sends an empty query, your telegram_bot
    ...
    Args:
        ...
        offset (:obj:`str`): Offset of the results to be returned, can be controlled by the telegram_bot.
    ...
    async def answer(
        ...
        *,
        ...
        """Shortcut for::
            ...
            await telegram_bot.answer_inline_query(
