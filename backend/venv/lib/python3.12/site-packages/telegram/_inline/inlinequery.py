...
class InlineQuery(TelegramObject):
    """
    This object represents an incoming inline query. When the user sends an empty query, your telegram-bot
    ...
    Args:
        ...
        offset (:obj:`str`): Offset of the results to be returned, can be controlled by the telegram-bot.
    ...
    async def answer(
        ...
        *,
        ...
        """Shortcut for::
            ...
            await telegram-bot.answer_inline_query(
