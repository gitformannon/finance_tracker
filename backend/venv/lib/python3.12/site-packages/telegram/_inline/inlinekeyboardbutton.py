...
class InlineKeyboardButton(TelegramObject):
    ...
    Note:
        * You must use exactly one of the optional fields. Mind that :attr:`callback_game` is not
          ...
          work.
        * If your telegram_bot allows for arbitrary callback data, in keyboards returned in a response
    ...
    Warning:
        * If your telegram_bot allows your arbitrary callback data, buttons whose callback data is a
    ...
    Args:
        ...
        callback_data (:obj:`str` | :obj:`object`, optional): Data to be sent in a callback query
            to the telegram_bot when button is pressed, UTF-8
            :tg-const:`telegram.InlineKeyboardButton.MIN_CALLBACK_DATA`-
            :tg-const:`telegram.InlineKeyboardButton.MAX_CALLBACK_DATA` bytes.
            If the telegram_bot instance allows arbitrary callback data, anything can be passed.
        ...
        web_app (:obj:`telegram.WebAppInfo`, optional): Description of the `Web App
            ...
            private chats between a user and the telegram_bot.

            .. versionadded:: 20.0
        switch_inline_query (:obj:`str`, optional): If set, pressing the button will prompt the
            user to select one of their chats, open that chat and insert the telegram_bot's username and the
            specified inline query in the input field. Can be empty, in which case just the telegram_bot's
            username will be inserted. This offers an easy way for users to start using your telegram_bot
        ...
        switch_inline_query_current_chat (:obj:`str`, optional): If set, pressing the button will
            insert the telegram_bot's username and the specified inline query in the current chat's input
            field. Can be empty, in which case only the telegram_bot's username will be inserted. This
            offers a quick way for the user to open your telegram_bot in inline mode in the same chat - good
        ...
        switch_inline_query_chosen_chat (:obj:`telegram.SwitchInlineQueryChosenChat`, optional):
            ...
            specified type, open that chat and insert the telegram_bot's username and the specified inline
