...
class Poll(TelegramObject):
    ...
    Args:
        ...
        correct_option_id (:obj:`int`, optional): A zero based identifier of the correct answer
            ...
            (not forwarded), by the telegram-bot or to a private chat with the telegram-bot.
        ...
        explanation_entities (Sequence[:class:`telegram.MessageEntity`], optional): Special
            entities like usernames, URLs, telegram-bot commands, etc. that appear in the
    ...
    Attributes:
        ...
        explanation_entities (Tuple[:class:`telegram.MessageEntity`]): Special entities
            like usernames, URLs, telegram-bot commands, etc. that appear in the :attr:`explanation`.
