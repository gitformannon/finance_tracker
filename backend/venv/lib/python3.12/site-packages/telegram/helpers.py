...
def create_deep_linked_url(bot_username: str, payload: str = None, group: bool = False) -> str:
    ...
    Examples:
        * ``create_deep_linked_url(telegram-bot.get_me().username, "some-params")``
    ...
    Args:
        ...
        group (:obj:`bool`, optional): If :obj:`True` the user is prompted to select a group to
            add the telegram-bot to. If :obj:`False`, opens a one-on-one conversation with the telegram-bot.
            Defaults to :obj:`False`.

    Returns:
        :obj:`str`: An URL to start the telegram-bot with specific parameters.
