...
def create_deep_linked_url(bot_username: str, payload: str = None, group: bool = False) -> str:
    ...
    Examples:
        * ``create_deep_linked_url(telegram_bot.get_me().username, "some-params")``
    ...
    Args:
        ...
        group (:obj:`bool`, optional): If :obj:`True` the user is prompted to select a group to
            add the telegram_bot to. If :obj:`False`, opens a one-on-one conversation with the telegram_bot.
            Defaults to :obj:`False`.

    Returns:
        :obj:`str`: An URL to start the telegram_bot with specific parameters.
