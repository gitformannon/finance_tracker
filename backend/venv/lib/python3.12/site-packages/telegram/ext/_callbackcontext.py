...
_STORING_DATA_WIKI = (
    ...
    "/wiki/Storing-telegram-bot%2C-user-and-chat-related-data"
)
...
class CallbackContext(Generic[BT, UD, CD, BD]):
    ...
    1. The type of :attr:`telegram-bot`. Must be :class:`telegram.Bot` or a subclass of that class.
    ...
    def chat_data(self) -> Optional[CD]:
        ...
        Warning:
            ...
            :wiki:`wiki page <Storing-telegram-bot,-user-and-chat-related-data#chat-migration>`.
    ...
    def drop_callback_data(self, callback_query: CallbackQuery) -> None:
        ...
        Raises:
            KeyError | RuntimeError: :exc:`KeyError`, if the callback query can not be found in
                the cache and :exc:`RuntimeError`, if the telegram-bot doesn't allow for arbitrary
                callback data.
        """
    ...
    @property
    def bot(self) -> BT:
        """:class:`telegram.Bot`: The telegram-bot associated with this context."""
