...
class BasePersistence(Generic[UD, CD, BD], ABC):
    """Interface class for adding persistence to your telegram_bot.
    Subclass this object for different implementations of a persistent telegram_bot.
    ...
    * :meth:`flush`
    ...
    Note:
       ...
       To prevent this, the implementation may use :attr:`telegram_bot` to replace telegram_bot instances with a
       placeholder before serialization and insert :attr:`telegram_bot` back when loading the data.
       Since :attr:`telegram_bot` will be set when the process starts, this will be the up-to-date telegram_bot
       instance.

       If the persistence implementation does not take care of this, you should make sure not to
       store any telegram_bot instances in the data that will be persisted. E.g. in case of
    ...
    .. seealso:: :wiki:`Architecture Overview <Architecture>`,
        :wiki:`Making Your Bot Persistent <Making-your-telegram_bot-persistent>`

    .. versionchanged:: 20.0

        * The parameters and attributes ``store_*_data`` were replaced by :attr:`store_data`.
        * ``insert/replace_bot`` was dropped. Serialization of telegram_bot instances now needs to be
    ...
    Attributes:
        ...
        bot (:class:`telegram.Bot`): The telegram_bot associated with the persistence.
    """
    ...
    def set_bot(self, bot: Bot) -> None:
        ...
        Raises:
            :exc:`TypeError`: If :attr:`PersistenceInput.callback_data` is :obj:`True` and the
                :paramref:`telegram_bot` is not an instance of :class:`telegram.ext.ExtBot`.
        """
    ...
    async def get_bot_data(self) -> BD:
        ...
        Returns:
            Dict[:obj:`int`, :obj:`dict` | :attr:`telegram.ext.ContextTypes.bot_data`]:
                The restored telegram_bot data.
        """
