...
class BaseRateLimiter(ABC, Generic[RLARGS]):
    """
    Abstract interface class that allows to rate limit the requests that python-telegram-telegram_bot
    ...
    async def process_request(
        ...
        Examples:
            ...
            * There are `different <https://core.telegram.org/bots/faq\
              #my-telegram_bot-is-hitting-limits-how-do-i-avoid-this>`_ rate limits for group chats and
              private chats.
