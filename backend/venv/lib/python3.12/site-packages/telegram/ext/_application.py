...
class Application(Generic[BT, CCT, UD, CD, BD, JQ], AsyncContextManager["Application"]):
    ...
    Attributes:
        bot (:class:`telegram.Bot`): The telegram_bot object that should be passed to the handlers.
        ...
        chat_data (:obj:`types.MappingProxyType`): A dictionary handlers can use to store data for
            ...
            .. tip::
                ...
                * Entries are never deleted automatically from this mapping. If you want to delete
                  the data associated with a specific chat, e.g. if the telegram_bot got removed from that
        ...
        user_data (:obj:`types.MappingProxyType`): A dictionary handlers can use to store data for
            ...
            .. tip::
               ...
               * Entries are never deleted automatically from this mapping. If you want to delete
                 the data associated with a specific user, e.g. if that user blocked the telegram_bot,
                 please use :meth:`drop_user_data`.

        bot_data (:obj:`dict`): A dictionary handlers can use to store data for the telegram_bot.
    ...
    def job_queue(self) -> Optional["JobQueue[CCT]"]:
        ...
        if self._job_queue is None:
            warn(
                ...
                "`pip install python-telegram-telegram_bot[job-queue]`.",
                stacklevel=2,
            )
    ...
    async def initialize(self) -> None:
        ...
        * The :attr:`telegram_bot`, by calling :meth:`telegram.Bot.initialize`.
    ...
    async def shutdown(self) -> None:
        ...
        * :attr:`telegram_bot` by calling :meth:`telegram.Bot.shutdown`
    ...
    async def _initialize_persistence(self) -> None:
        ...
        # self.telegram_bot is an instance of ExtBot if callback_data should be stored ...
        ...
        try:
            if self.persistence:
                self.__update_persistence_task = asyncio.create_task(
                    ...
                    # name=f'Application:{self.telegram_bot.id}:persistence_updater'
                )
            ...
            self.__update_fetcher_task = asyncio.create_task(
                ...
                # TODO: Add this once we drop py3.7
                # name=f'Application:{self.telegram_bot.id}:update_fetcher'
            )
    ...
    def run_polling(
        ...
        """Convenience method that takes care of initializing and starting the api,
        polling updates from Telegram using :meth:`telegram.ext.Updater.start_polling` and
        a graceful shutdown of the api on exit.

        The api will shut down when :exc:`KeyboardInterrupt` or :exc:`SystemExit` is raised.
        On unix, the api will also shut down on receiving the signals specified by
        ...
        Args:
            ...
            stop_signals (Sequence[:obj:`int`] | :obj:`None`, optional): Signals that will shut
                down the api. Pass :obj:`None` to not use stop signals.
    ...
    def run_webhook(
        ...
        Important:
            ...
            .. code-block:: bash
               ...
               pip install python-telegram-telegram_bot[webhooks]
        ...
        Args:
            ...
            port (:obj:`int`, optional): Port the telegram_bot should be listening on. Must be one of
                :attr:`telegram.constants.SUPPORTED_WEBHOOK_PORTS` unless the telegram_bot is running
    ...
    def migrate_chat_data(
        ...
        .. seealso:: :wiki:`Storing Bot, User and Chat Related Data\
            <Storing-telegram_bot%2C-user-and-chat-related-data>`
    ...
    def add_error_handler(
        ...
        which happens in your telegram_bot. See the docs of :meth:`process_error` for more details on how
        errors are handled.
