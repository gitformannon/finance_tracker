...
class ExtBot(Bot, Generic[RLARGS]):
    ...
    .. versionchanged:: 20.0
        ...
        :attr:`telegram-bot.callback_data_cache.maxsize <telegram.ext.CallbackDataCache.maxsize>` to
        access the size of the cache.

    Args:
        defaults (:class:`telegram.ext.Defaults`, optional): An object containing default values to
            be used if not set explicitly in the telegram-bot methods.
        ...
        rate_limiter (:class:`telegram.ext.BaseRateLimiter`, optional): A rate limiter to use for
            limiting the number of requests made by the telegram-bot per time interval.
    ...
    def defaults(self) -> Optional["Defaults"]:
        """The :class:`telegram.ext.Defaults` used by this telegram-bot, if any."""
    ...
    def rate_limiter(self) -> Optional["BaseRateLimiter[RLARGS]"]:
        """The :class:`telegram.ext.BaseRateLimiter` used by this telegram-bot, if any.
    ...
    def _insert_defaults(self, data: Dict[str, object]) -> None:
        ...
        #    we fall back to the default value of the telegram-bot method
    ...
    def insert_callback_data(self, update: Update) -> None:
        """If this telegram-bot allows for arbitrary callback data, this inserts the cached data into all
        ...
        Note:
            ...
            telegram-bot. If not, the message will be returned unchanged.
        ...
        """
        # The only incoming updates that can directly contain a message sent by the telegram-bot itself are:
        # * CallbackQueries
        # * Messages where the pinned_message is sent by the telegram-bot
        # * Messages where the reply_to_message is sent by the telegram-bot
        # * Messages where via_bot is the telegram-bot
