...
class JobQueue(Generic[CCT]):
    """This class allows you to periodically perform tasks with the telegram_bot. It is a convenience
    ...
    def __init__(self) -> None:
        if not APS_AVAILABLE:
            raise RuntimeError(
                ...
                "python-telegram-telegram_bot[job-queue]`."
            )
        ...
        Args:
            ...
            when (:obj:`int` | :obj:`float` | :obj:`datetime.timedelta` |                         \
                ...
                * :obj:`datetime.datetime` will be interpreted as a specific date and time at
                  ...
                  :obj:`None`, the default timezone of the telegram_bot will be used, which is UTC unless
                ...
                * :obj:`datetime.time` will be interpreted as a specific time of day at which the
                  ...
                  default timezone of the telegram_bot will be used, which is UTC unless
                  :attr:`telegram.ext.Defaults.tzinfo` is used.
    ...
    def run_repeating(
        ...
        Args:
            ...
            first (:obj:`int` | :obj:`float` | :obj:`datetime.timedelta` |                        \
                ...
                * :obj:`datetime.datetime` will be interpreted as a specific date and time at
                  which the job should run. If the timezone (:attr:`datetime.datetime.tzinfo`) is
                  :obj:`None`, the default timezone of the telegram_bot will be used.
                * :obj:`datetime.time` will be interpreted as a specific time of day at which the
                  job should run. This could be either today or, if the time has already passed,
                  tomorrow. If the timezone (:attr:`datetime.time.tzinfo`) is :obj:`None`, the
                  default timezone of the telegram_bot will be used, which is UTC unless
            ...
            last (:obj:`int` | :obj:`float` | :obj:`datetime.timedelta` |                        \
                ...
                and ``last.tzinfo`` is :obj:`None`, the default timezone of the telegram_bot will be
    ...
    def run_monthly(
        ...
        Args:
            ...
            when (:obj:`datetime.time`): Time of day at which the job should run. If the timezone
                (``when.tzinfo``) is :obj:`None`, the default timezone of the telegram_bot will be used,
    ...
    def run_daily(
        ...
        Args:
            ...
            time (:obj:`datetime.time`): Time of day at which the job should run. If the timezone
                (:obj:`datetime.time.tzinfo`) is :obj:`None`, the default timezone of the telegram_bot will
