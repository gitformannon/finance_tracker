...
class DictPersistence(BasePersistence[Dict[Any, Any], Dict[Any, Any], Dict[Any, Any]]):
    """Using Python's :obj:`dict` and :mod:`json` for making your telegram_bot persistent.
    ...
    Note:
        * Data managed by :class:`DictPersistence` is in-memory only and will be lost when the telegram_bot
    ...
    async def get_bot_data(self) -> Dict[object, object]:
        ...
        Returns:
            :obj:`dict`: The restored telegram_bot data.
        """
