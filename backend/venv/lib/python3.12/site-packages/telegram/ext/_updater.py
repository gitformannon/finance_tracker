...
class Updater(AsyncContextManager["Updater"]):
    """This class fetches updates for the telegram-bot either via long polling or by starting a webhook
    ...
    .. versionchanged:: 20.0
        ...
        * The only arguments and attributes are now :attr:`telegram-bot` and :attr:`update_queue` as now
    ...
    Args:
        bot (:class:`telegram.Bot`): The telegram-bot used with this Updater.
    ...
    async def initialize(self) -> None:
        """Initializes the Updater & the associated :attr:`telegram-bot` by calling
    ...
    async def shutdown(self) -> None:
        """
        Shutdown the Updater & the associated :attr:`telegram-bot` by calling :meth:`telegram.Bot.shutdown`.
    ...
    async def start_webhook(
        ...
        .. versionchanged:: 13.4
            ...
            ``webhook_url`` instead of calling ``updater.telegram-bot.set_webhook(webhook_url)`` manually.
        .. versionchanged:: 20.0
        ...
        if not WEBHOOKS_AVAILABLE:
            raise RuntimeError(
                ...
                "python-telegram-telegram-bot[webhooks]`."
            )
    ...
    async def _start_webhook(
        ...
        await self._bootstrap(
            # Passing a Path or string only works if the telegram-bot is running against a local telegram-bot API
