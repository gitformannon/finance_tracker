...
class Updater(AsyncContextManager["Updater"]):
    """This class fetches updates for the telegram_bot either via long polling or by starting a webhook
    ...
    .. versionchanged:: 20.0
        ...
        * The only arguments and attributes are now :attr:`telegram_bot` and :attr:`update_queue` as now
    ...
    Args:
        bot (:class:`telegram.Bot`): The telegram_bot used with this Updater.
    ...
    async def initialize(self) -> None:
        """Initializes the Updater & the associated :attr:`telegram_bot` by calling
    ...
    async def shutdown(self) -> None:
        """
        Shutdown the Updater & the associated :attr:`telegram_bot` by calling :meth:`telegram.Bot.shutdown`.
    ...
    async def start_webhook(
        ...
        .. versionchanged:: 13.4
            ...
            ``webhook_url`` instead of calling ``updater.telegram_bot.set_webhook(webhook_url)`` manually.
        .. versionchanged:: 20.0
        ...
        if not WEBHOOKS_AVAILABLE:
            raise RuntimeError(
                ...
                "python-telegram-telegram_bot[webhooks]`."
            )
    ...
    async def _start_webhook(
        ...
        await self._bootstrap(
            # Passing a Path or string only works if the telegram_bot is running against a local telegram_bot API
