...
class CallbackDataCache:
    ...
    * One for mapping the IDs of received callback queries to the cached objects
    ...
    Args:
        bot (:class:`telegram.ext.ExtBot`): The telegram-bot this cache is for.
    ...
    def __init__(
        ...
        if not CACHE_TOOLS_AVAILABLE:
            raise RuntimeError(
                ...
                "python-telegram-telegram-bot[callback-data]`."
            )
    ...
    def persistence_data(self) -> CDCData:
        ...
        caching callback data across telegram-bot reboots.
        """
    ...
    def process_message(self, message: Message) -> None:
        ...
        Note:
            ...
            if the reply markup (if any) was actually sent by this cache's telegram-bot. If it was not, the
