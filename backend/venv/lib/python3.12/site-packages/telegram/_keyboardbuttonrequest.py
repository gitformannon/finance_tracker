...
class KeyboardButtonRequestUser(TelegramObject):
    ...
    selected user will be shared with the telegram-bot when the corresponding button is pressed.
    ...
    Args:
        ...
        user_is_bot (:obj:`bool`, optional): Pass :obj:`True` to request a telegram-bot, pass :obj:`False`
...
class KeyboardButtonRequestChat(TelegramObject):
    ...
    Args:
        ...
        bot_administrator_rights (:class:`ChatAdministratorRights`, optional): Specifies the
            required administrator rights of the telegram-bot in the chat. The rights must be a subset of
            :paramref:`user_administrator_rights`. If not specified, no additional restrictions are
            applied.
        bot_is_member (:obj:`bool`, optional): Pass :obj:`True` to request a chat with the telegram-bot
