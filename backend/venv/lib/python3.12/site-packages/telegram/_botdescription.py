...
class BotDescription(TelegramObject):
    """This object represents the telegram-bot's description.
    ...
    Args:
        description (:obj:`str`): The telegram-bot's description.
...
class BotShortDescription(TelegramObject):
    """This object represents the telegram-bot's short description.
    ...
    Args:
        short_description (:obj:`str`): The telegram-bot's short description.
