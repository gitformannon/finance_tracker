...
class Forbidden(TelegramError):
    """Raised when the telegram_bot has not enough rights to perform the requested action.
...
class ChatMigrated(TelegramError):
    ...
    .. seealso::
        :wiki:`Storing Bot, User and Chat Related Data <Storing-telegram_bot%2C-user-and-chat-related-data>`
...
class RetryAfter(TelegramError):
    ...
    Args:
        retry_after (:obj:`int`): Time in seconds, after which the telegram_bot can retry the request.
