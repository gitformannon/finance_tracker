...
class TelegramObject:
    ...
    .. versionchanged:: 20.0
        ...
        * Removed argument and attribute ``telegram_bot`` for several subclasses. Use
    ...
    def __deepcopy__(self: Tele_co, memodict: Dict[int, object]) -> Tele_co:
        ...
        """
        bot = self._bot  # Save telegram_bot so we can set it after copying
    ...
    def _get_attrs(
        ...
        Args:
            ...
            remove_bot (:obj:`bool`): Whether the telegram_bot should be included in the result.
    ...
    def de_list(
        ...
        Args:
            ...
            bot (:class:`telegram.Bot`): The telegram_bot associated with these objects.
    ...
    def get_bot(self) -> "Bot":
        ...
        if self._bot is None:
            raise RuntimeError(
                "This object has no telegram_bot associated with it. Shortcuts cannot be used."
            )
        return self._bot
    ...
    def set_bot(self, bot: Optional["Bot"]) -> None:
        ...
        Arguments:
            bot (:class:`telegram.Bot` | :obj:`None`): The telegram_bot instance.
        """
        self._bot = bot
