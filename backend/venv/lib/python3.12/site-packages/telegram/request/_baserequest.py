...
class BaseRequest(
    ...
    """Abstract interface class that allows python-telegram-telegram-bot to make requests to the Bot API.
    ...
    USER_AGENT: ClassVar[str] = f"python-telegram-telegram-bot v{ptb_ver} (https://python-telegram-bot.org)"
