...
def print_ver_info() -> None:  # skipcq: PY-D0003
    """Prints version information for python-telegram-telegram-bot, the Bot API and Python."""
    git_revision = _git_revision()
    print(f"python-telegram-telegram-bot {telegram_ver}" + (f" ({git_revision})" if git_revision else ""))
