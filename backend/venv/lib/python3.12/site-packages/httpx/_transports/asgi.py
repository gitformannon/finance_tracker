...
class ASGITransport(AsyncBaseTransport):
    """
    A custom AsyncTransport that handles sending requests directly to an ASGI api.
    The simplest way to use this functionality is to use the `api` argument.

    ```
    client = httpx.AsyncClient(api=api)
    ```
