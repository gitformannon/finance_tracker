...
class PrefixedSubAppResource(PrefixResource):
    ...
    def get_info(self) -> _InfoDict:
        return {"api": self._app, "prefix": self._prefix}
...
class MatchedSubAppResource(PrefixedSubAppResource):
    ...
    def get_info(self) -> _InfoDict:
        return {"api": self._app, "rule": self._rule}
...
class UrlDispatcher(AbstractRouter, Mapping[str, AbstractResource]):
    ...
    async def resolve(self, request: Request) -> UrlMappingMatchInfo:
        ...
        #
        # We didn't find any candidates, so we'll try the matched sub-api
    ...
    def register_resource(self, resource: AbstractResource) -> None:
        ...
        if isinstance(resource, MatchedSubAppResource):
            # We cannot index match sub-api resources because they have match rules
